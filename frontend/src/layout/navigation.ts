...
export const navigationDomains: NavigationDomain[] = [
  {
    ...
    items: [
      { to: "/", label: "经营概览", icon: LayoutDashboard, permission: "analytics.read", menuCode: "route:overview" },
      { to: "/big-screen", label: "经营大屏", icon: Monitor, permission: "analytics.read", menuCode: "route:big-screen" },
    ],
  },
  {
    key: "ai",
  ...
  },
  {
    ...
    label: "流量",
    icon: Route,
    items: [{ to: "/traffic", label: "流量归因", icon: Route, permission: "analytics.read", menuCode: "route:traffic" }],
  },
  {
    key: "market",
    to: "/market",
...
const sidebarGroupDefinitions: Omit<SidebarGroup, "domains">[] = [
  ...
  },
  {
    ...
    label: "营销与推广",
    icon: Megaphone,
    domainKeys: ["promotion", "marketing-activities", "brand-assets"],
  },
  {
    key: "customer-service",
    label: "客户与服务",
    icon: UsersRound,
    domainKeys: ["customers", "service", "content"],
  },
  {
    key: "data",
    label: "数据管理",
