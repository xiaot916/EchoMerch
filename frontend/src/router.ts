  ...
  routes: [
    {
      ...
      component: AppShell,
      children: [
        { path: "", name: "overview", component: () => import("@/views/OverviewView.vue"), meta: { title: "经营概览", eyebrow: "天猫经营数据", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        ...
        { path: "analytics", name: "analytics", component: () => import("@/views/AnalyticsView.vue"), meta: { title: "交易分析", eyebrow: "交易与效率", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "products", name: "products", component: () => import("@/views/ProductsView.vue"), meta: { title: "商品表现", eyebrow: "商品经营洞察", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "traffic", name: "traffic", component: () => import("@/views/TrafficView.vue"), meta: { title: "流量归因", eyebrow: "来源与访客质量", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "promotions", name: "promotions", component: () => import("@/views/PromotionsView.vue"), meta: { title: "推广分析", eyebrow: "渠道与投入产出", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "promotions/cps", name: "promotions-cps", component: () => import("@/views/CpsView.vue"), meta: { title: "CPS 分析", eyebrow: "商品推广 / CPS 渠道", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "customers", name: "customers", component: () => import("@/views/CustomersView.vue"), meta: { title: "客户概况", eyebrow: "客户", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "customers/members", name: "customer-members", component: () => import("@/views/MembersView.vue"), meta: { title: "会员分析", eyebrow: "客户与复购", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "marketing/activities", name: "marketing-activities", component: () => import("@/views/ActivitiesView.vue"), meta: { title: "活动复盘", eyebrow: "营销活动", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "marketing/flash-sale", name: "marketing-flash-sale", component: () => import("@/views/FlashSaleView.vue"), meta: { title: "淘宝秒杀", eyebrow: "营销活动 / 秒杀经营", requiresDashboard: false, surface: "business", permission: "analytics.read" } },
        { path: "marketing/new-customer", name: "marketing-new-customer", component: () => import("@/views/NewCustomerView.vue"), meta: { title: "新客折扣", eyebrow: "营销活动", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "marketing/shopping-gold", name: "marketing-shopping-gold", component: () => import("@/views/MarketingChannelView.vue"), meta: { title: "购物金", eyebrow: "营销活动", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "marketing/bybt", name: "marketing-bybt", component: () => import("@/views/MarketingChannelView.vue"), meta: { title: "百亿补贴", eyebrow: "营销活动", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "marketing/utry", name: "marketing-utry", component: () => import("@/views/UtryView.vue"), meta: { title: "U先试用", eyebrow: "营销活动 / 派样与复购", requiresDashboard: false, surface: "business", permission: "analytics.read" } },
        { path: "service", name: "service", component: () => import("@/views/CustomerServiceView.vue"), meta: { title: "客服概览", eyebrow: "客服经营", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        ...
        { path: "content", name: "content", component: () => import("@/views/ContentView.vue"), meta: { title: "内容概览", eyebrow: "内容经营", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "live", name: "live", component: () => import("@/views/LiveView.vue"), meta: { title: "直播分析", eyebrow: "内容与服务 / 直播经营", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "market", name: "market", component: () => import("@/views/MarketView.vue"), meta: { title: "市场洞察", eyebrow: "市场分析", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        { path: "brand-assets", name: "brand-assets", component: () => import("@/views/BrandAssetsView.vue"), meta: { title: "品牌资产", eyebrow: "品牌", requiresDashboard: false, surface: "system", permission: "brand_assets.read" } },
        { path: "products/analysis", name: "product-analysis", component: () => import("@/views/ProductAnalysisView.vue"), meta: { title: "单品分析", eyebrow: "商品经营 / 单品下钻", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
        ...
        { path: "inventory", name: "inventory", component: () => import("@/views/InventoryView.vue"), meta: { title: "库存管理", eyebrow: "商品编码与库存快照", requiresDashboard: false, surface: "system", permission: "analytics.read" } },
        ...
        { path: "reviews", name: "reviews", component: () => import("@/views/ReviewsView.vue"), meta: { title: "评价分析", eyebrow: "商品质量与用户反馈", requiresDashboard: false, surface: "system", permission: "analytics.read" } },
