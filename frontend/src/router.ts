  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: "marketing/new-customer", name: "marketing-new-customer", component: () => import("@/views/NewCustomerView.vue"), meta: { title: "新客礼金", eyebrow: "营销活动", requiresDashboard: true, surface: "business", permission: "analytics.read" } },
