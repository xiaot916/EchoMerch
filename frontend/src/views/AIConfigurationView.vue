...
<style scoped>
.ai-config-test { display:inline-flex; min-height:36px; align-items:center; gap:7px; border:1px solid #16845b; border-radius:5px; padding:0 13px; color:#fff; background:#16845b; font-size: 12px; cursor:pointer }.ai-config-test:disabled{opacity:.55;cursor:not-allowed}.admin-inline-message{margin-top:14px}.ai-config-stats{margin-top:14px}.ai-config-stats strong{overflow:hidden;font-size:16px;text-overflow:ellipsis;white-space:nowrap}.ai-config-layout{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(320px,.65fr);gap:14px;margin-top:14px}.ai-config-form,.ai-config-status{min-width:0}.ai-config-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:13px;margin-top:15px}.ai-config-grid label{display:grid;gap:6px;color:#6f8077;font-size: 12px}.ai-config-grid label.wide{grid-column:1/-1}.ai-config-grid input{width:100%;box-sizing:border-box;min-height:36px;border:1px solid #dbe5df;border-radius:5px;padding:0 10px;color:#354b3f;background:#fff;font-size: 12px;outline:none}.ai-config-grid input:focus{border-color:#55a783;box-shadow:0 0 0 2px rgba(22,132,91,.08)}.ai-config-grid small{color:#98a49e;font-size: 12px}.ai-key-field{display:flex;align-items:center;gap:7px;border:1px solid #dbe5df;border-radius:5px;padding:0 10px;color:#7c8c83;background:#fff}.ai-key-field input{border:0;padding:0;box-shadow:none!important}.ai-clear-key{display:inline-flex;align-items:center;gap:7px;margin-top:13px;color:#8b5a5a;font-size: 12px}.ai-clear-key input{accent-color:#b44f4f}.ai-config-actions{display:flex;align-items:center;gap:12px;margin-top:16px;border-top:1px solid #edf2ef;padding-top:14px}.ai-config-actions>span{display:flex;align-items:center;gap:6px;margin-right:auto;color:#819088;font-size: 12px}.ai-config-actions button{display:inline-flex;min-height:35px;align-items:center;gap:6px;border:1px solid #16845b;border-radius:5px;padding:0 14px;color:#fff;background:#16845b;font-size: 12px;cursor:pointer}.ai-config-actions button:disabled{opacity:.55}.ai-connection-result{display:flex;align-items:flex-start;gap:10px;margin-top:15px;border:1px solid;border-radius:6px;padding:13px}.ai-connection-result.success{border-color:#bfe3cf;color:#14734f;background:#f2fbf6}.ai-connection-result.failed{border-color:#efcaca;color:#aa4141;background:#fff7f7}.ai-connection-result div{display:grid;gap:4px;min-width:0}.ai-connection-result strong{font-size:12px}.ai-connection-result span,.ai-connection-result small{overflow-wrap:anywhere;font-size: 12px}.ai-connection-empty{display:grid;justify-items:center;gap:7px;margin-top:15px;border:1px dashed #dce6e0;border-radius:6px;padding:24px 14px;color:#85938b;text-align:center}.ai-connection-empty strong{color:#53675c;font-size:12px}.ai-connection-empty span{max-width:310px;font-size: 12px;line-height:1.6}.ai-endpoint-summary{display:grid;gap:0;margin:15px 0 0}.ai-endpoint-summary div{display:grid;grid-template-columns:74px minmax(0,1fr);gap:8px;border-top:1px solid #edf2ef;padding:10px 0;font-size: 12px}.ai-endpoint-summary dt{color:#8c9992}.ai-endpoint-summary dd{margin:0;overflow-wrap:anywhere;color:#50645a;text-align:right}@media(max-width:1000px){.ai-config-layout{grid-template-columns:1fr}}@media(max-width:680px){.ai-config-grid{grid-template-columns:1fr}.ai-config-grid label.wide{grid-column:auto}.ai-config-actions{align-items:flex-start;flex-direction:column}.ai-config-actions button{width:100%;justify-content:center}}
</style>
