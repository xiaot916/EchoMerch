...
.notification-layout { display: grid; grid-template-columns: minmax(320px, .8fr) minmax(460px, 1.4fr); gap: 14px; align-items: start; }.notification-safe-note { margin: 9px 0 14px; color: #7c8c83; font-size: 12px; line-height: 1.6; }
.notification-channel-list { display: grid; gap: 7px; }.notification-channel-list > button { display: grid; grid-template-columns: 34px 1fr auto 26px; align-items: center; gap: 8px; width: 100%; border: 1px solid #e0e9e3; border-radius: 6px; padding: 9px; color: #40554a; background: #fff; text-align: left; cursor: pointer; }.notification-channel-list > button.active { border-color: #4da47e; box-shadow: 0 0 0 2px rgba(22,132,91,.08); }.channel-icon { display: grid; place-items: center; width: 32px; height: 32px; border-radius: 6px; color: #16845b; background: #eef8f3; }.notification-channel-list strong,.notification-channel-list small { display:block; }.notification-channel-list small { margin-top: 3px; color:#89978f; font-size: 12px; }.notification-channel-list em { border-radius: 99px; padding: 3px 7px; font-size: 12px; font-style: normal; }.notification-channel-list em.ready { color:#14734f; background:#eaf8f1; }.notification-channel-list em.pending { color:#987026; background:#fff7e7; }.notification-channel-list i { display:grid; place-items:center; width:25px; height:25px; border-radius:4px; color:#809087; font-style:normal; }.notification-channel-list i:hover { color:#16845b; background:#eef7f2; }
.notification-empty { display:flex; align-items:center; justify-content:center; gap:8px; min-height:80px; color:#93a098; font-size: 12px; }.notification-channel-form { display:grid; gap:10px; margin-top:16px; border-top:1px solid #edf2ef; padding-top:15px; }.notification-form-title { display:flex; justify-content:space-between; align-items:center; color:#40554a; font-size:12px; }.notification-form-title button { border:0; color:#16845b; background:transparent; font-size: 12px; cursor:pointer; }.notification-channel-form label,.notification-field,.notification-compose-grid label { display:grid; gap:5px; color:#708078; font-size: 12px; }.notification-channel-form input,.notification-compose-grid select,.notification-field input,.notification-field textarea { width:100%; box-sizing:border-box; border:1px solid #dbe5df; border-radius:5px; padding:8px 9px; color:#354b3f; background:#fff; font:inherit; font-size: 12px; outline:none; }.notification-field textarea { resize:vertical; min-height:170px; line-height:1.65; }.notification-channel-form input:focus,.notification-compose-grid select:focus,.notification-field input:focus,.notification-field textarea:focus { border-color:#55a783; box-shadow:0 0 0 2px rgba(22,132,91,.08); }.notification-check { display:inline-flex !important; grid-template-columns:auto 1fr; align-items:center; gap:7px !important; }.notification-check input { width:auto; accent-color:#16845b; }.notification-primary { display:inline-flex; align-items:center; justify-content:center; gap:6px; border:1px solid #16845b; border-radius:5px; min-height:34px; padding:0 13px; color:#fff; background:#16845b; font-size: 12px; cursor:pointer; }.notification-primary:disabled { cursor:not-allowed; opacity:.5; }
.notification-compose-grid { display:grid; grid-template-columns:1fr 160px; gap:10px; margin:13px 0 11px; }.notification-field { margin-bottom:11px; }.notification-send-row { display:flex; align-items:center; gap:12px; border-top:1px solid #edf2ef; padding-top:13px; }.notification-send-row > span { margin-right:auto; color:#89978f; font-size: 12px; }
.notification-history-panel { margin-top:14px; }.notification-table-wrap { overflow-x:auto; margin-top:10px; }.notification-table { width:100%; min-width:900px; border-collapse:collapse; table-layout:fixed; }.notification-table th,.notification-table td { border-bottom:1px solid #edf2ef; padding:10px 8px; color:#65766d; font-size: 12px; text-align:left; vertical-align:top; }.notification-table th { color:#8b9890; font-size: 12px; font-weight:650; }.notification-table th:nth-child(1){width:70px}.notification-table th:nth-child(2){width:130px}.notification-table th:nth-child(4){width:90px}.notification-table th:nth-child(5){width:140px}.notification-table th:nth-child(6){width:170px}.notification-table td strong,.notification-table td small { display:block; }.notification-table td strong { color:#40554a; font-size: 12px; }.notification-table td small { margin-top:4px; color:#929e97; font-size: 12px; }.notification-content-cell small { overflow:hidden; max-width:460px; text-overflow:ellipsis; white-space:nowrap; }.response-cell { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }.delivery-status { display:inline-flex; align-items:center; gap:4px; border-radius:99px; padding:3px 6px; }.delivery-status.sent { color:#14734f;background:#eaf8f1}.delivery-status.failed {color:#b04444;background:#fff0f0}.delivery-status.sending {color:#987026;background:#fff7e7}.notification-empty-cell { padding:30px !important; color:#94a199 !important; text-align:center !important; }
.notification-pagination { display:flex; align-items:center; gap:10px; padding-top:13px; color:#87958d; font-size: 12px; }.notification-pagination > span { margin-right:auto; }.notification-pagination label { display:flex; align-items:center; gap:5px; }.notification-pagination select { border:1px solid #dbe5df; border-radius:4px; padding:4px; color:#52665a; background:#fff; }.notification-pagination > div { display:flex; gap:4px; }.notification-pagination button { min-width:28px; border:1px solid #dbe5df; border-radius:4px; padding:5px 7px; color:#52665a; background:#fff; font-size: 12px; cursor:pointer; }.notification-pagination button.active { border-color:#16845b; color:#fff; background:#16845b; }.notification-pagination button:disabled { opacity:.4; cursor:not-allowed; }
