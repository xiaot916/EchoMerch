...
const trendOption = computed(() => {
  ...
  return { tooltip: { trigger: "axis", valueFormatter: (value: unknown) => value == null ? "暂无" : `${Number(value).toFixed(2)}%` }, legend: { top: 0, textStyle: { color: "#66786f", fontSize: 12 } }, grid: { left: 10, right: 16, top: 38, bottom: 10, containLabel: true }, xAxis: { type: "category", data: data.map((item) => item.stat_date.slice(5)), axisLabel: { color: "#819087", fontSize: 12 }, axisLine: { lineStyle: { color: "#dfe8e2" } } }, yAxis: { type: "value", axisLabel: { color: "#819087", fontSize: 12, formatter: "{value}%" }, splitLine: { lineStyle: { color: "#edf2ee" } } }, series: [{ name: "样本平均点击率", type: "line", smooth: true, data: data.map((item) => item.average_click_rate), symbolSize: 6, itemStyle: { color: "#218b66" }, lineStyle: { width: 2.5 }, areaStyle: { color: "rgba(33,139,102,.08)" } }, { name: "样本平均支付转化", type: "line", smooth: true, data: data.map((item) => item.average_pay_conversion_rate), symbolSize: 6, itemStyle: { color: "#d18a43" }, lineStyle: { width: 2.2 } }] }
})
...
<style scoped>
.market-hero { align-items: center; }.market-state { display: flex; align-items: center; justify-content: center; gap: 10px; min-height: 180px; border: 1px solid #e1e9e4; border-radius: 10px; background: #fff; color: #63766c; }.market-error { color: #a85f50; }.market-error button { border: 1px solid #d7e2db; border-radius: 6px; padding: 7px 12px; background: #fff; color: #316d55; cursor: pointer; }.market-status { display: flex; align-items: center; justify-content: space-between; gap: 20px; margin-top: 14px; padding: 13px 16px; }.market-status > div { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; }.market-status svg { color: #278d68; }.market-status strong { color: #304a3e; font-size: 12px; }.market-status span, .market-status small { color: #73847b; font-size: 12px; }
.market-command-grid, .market-insight-grid, .market-signal-grid, .market-table-grid { display: grid; gap: 14px; margin-top: 14px; }.market-command-grid { grid-template-columns: minmax(0, 1.45fr) minmax(300px, .55fr); }.market-insight-grid { grid-template-columns: minmax(0, 1.2fr) minmax(350px, .8fr); }.market-signal-grid, .market-table-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }.market-command-grid > .panel, .market-insight-grid > .panel, .market-signal-grid > .panel, .market-table-grid > .panel { min-width: 0; padding: 17px; }.decision-list { display: grid; gap: 8px; margin-top: 10px; }.decision-card { display: grid; grid-template-columns: 35px minmax(0, 1fr); gap: 11px; border: 1px solid #e3ebe6; border-radius: 8px; padding: 12px; background: #fbfdfc; }.decision-priority { display: grid; width: 32px; height: 28px; place-items: center; border-radius: 6px; background: #dff2e9; color: #167a55; font-size: 12px; font-weight: 750; }.decision-card > div { min-width: 0; }.decision-title { display: flex; align-items: center; flex-wrap: wrap; gap: 6px; }.decision-title em { color: #278661; font-size: 12px; font-style: normal; font-weight: 650; }.decision-title strong { color: #2d493c; font-size: 12px; }.decision-title small { margin-left: auto; border-radius: 999px; padding: 2px 6px; font-size: 12px; }.confidence-high { background: #e1f3ea; color: #1c7d59; }.confidence-medium { background: #fff3dd; color: #9b6b26; }.confidence-low { background: #fff0eb; color: #ae6655; }.decision-card p { margin: 5px 0 8px; color: #5e7268; font-size: 12px; line-height: 1.5; }.decision-card dl { display: grid; gap: 4px; margin: 0; }.decision-card dl div { display: grid; grid-template-columns: 32px minmax(0, 1fr); gap: 6px; }.decision-card dt { color: #90a098; font-size: 12px; }.decision-card dd { margin: 0; color: #667b70; font-size: 12px; line-height: 1.45; }
.audit-score { display: flex; align-items: center; gap: 12px; margin: 14px 0; border-radius: 8px; padding: 12px; background: #eef7f2; }.audit-score > strong { display: grid; width: 48px; height: 48px; place-items: center; border: 1px solid #cfe7da; border-radius: 50%; color: #207b59; font-size: 20px; }.audit-score div { display: grid; gap: 3px; }.audit-score b { color: #385447; font-size: 12px; }.audit-score span { color: #71857a; font-size: 12px; }.coverage-list { display: grid; gap: 5px; }.coverage-list > div { display: grid; grid-template-columns: 18px minmax(0, 1fr) auto; gap: 7px; align-items: center; border-bottom: 1px solid #ebf0ed; padding: 8px 0; }.coverage-list svg { color: #258461; }.coverage-list span { display: grid; gap: 2px; }.coverage-list b { color: #435b50; font-size: 12px; }.coverage-list small { color: #84938b; font-size: 12px; }.coverage-list em { border-radius: 999px; padding: 3px 7px; background: #e6f4ed; color: #21805d; font-size: 12px; font-style: normal; }.coverage-list em.partial, .coverage-list em.empty { background: #fff2e5; color: #aa6d35; }.audit-flags { margin-top: 10px; border-left: 2px solid #d69a64; padding-left: 9px; }.audit-flags p { margin: 3px 0; color: #8b6b55; font-size: 12px; line-height: 1.45; }.audit-boundary, .panel-footnote { margin: 10px 0 0; color: #768980; font-size: 12px; line-height: 1.55; }
.segment-list { display: grid; gap: 2px; margin-top: 10px; }.segment-row { display: grid; grid-template-columns: minmax(0, 1.4fr) repeat(3, minmax(62px, .65fr)); gap: 8px; align-items: center; border-bottom: 1px solid #ebf0ed; padding: 12px 0; }.segment-row > div { min-width: 0; display: grid; gap: 3px; }.segment-row strong { color: #344f42; font-size: 12px; }.segment-row small { overflow: hidden; color: #83928a; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }.segment-row > span { display: grid; gap: 2px; text-align: right; }.segment-row b { color: #2f745a; font-size: 12px; }.segment-row > span small { overflow: visible; white-space: normal; }.demand-list, .competition-list { display: grid; margin-top: 8px; }.demand-list > article { display: grid; grid-template-columns: 72px minmax(0, 1fr) 150px; gap: 9px; align-items: center; border-bottom: 1px solid #ebf0ed; padding: 10px 0; }.direction-chip { justify-self: start; border-radius: 999px; padding: 4px 7px; background: #eef2ef; color: #78887f; font-size: 12px; }.direction-chip.rising { background: #e0f3ea; color: #187b56; }.direction-chip.new { background: #e8eefc; color: #5270b5; }.direction-chip.falling { background: #fff0eb; color: #ad6654; }.demand-list article > div:nth-child(2) { min-width: 0; display: grid; gap: 3px; }.demand-list strong, .competition-list strong { overflow: hidden; color: #344f42; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }.demand-list small, .demand-list p, .competition-list small, .competition-list p { margin: 0; color: #7d8d84; font-size: 12px; line-height: 1.45; }.demand-metrics { display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px; }.demand-metrics span { display: grid; gap: 2px; color: #8a9991; font-size: 12px; text-align: right; }.demand-metrics b { color: #356f58; font-size: 12px; }.competition-list > article { display: grid; grid-template-columns: 26px minmax(0, 1fr); gap: 8px; border-bottom: 1px solid #ebf0ed; padding: 10px 0; }.competition-list > article > span { display: grid; width: 24px; height: 24px; place-items: center; border-radius: 50%; }.competition-list > article > span.rising { background: #e0f3ea; color: #187b56; }.competition-list > article > span.falling { background: #fff0eb; color: #ad6654; }.competition-list article div { min-width: 0; display: grid; gap: 3px; }
.market-content-panel, .market-toolbar-panel { margin-top: 14px; padding: 17px; }.market-content-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 9px; margin-top: 9px; }.market-content-card { display: grid; grid-template-columns: 31px minmax(0, 1fr); gap: 9px; border: 1px solid #e3ebe6; border-radius: 7px; padding: 11px; background: #fbfdfc; }.market-content-card > span { display: grid; width: 29px; height: 29px; place-items: center; border-radius: 6px; background: #e4f2eb; color: #247f5f; font-size: 12px; font-weight: 700; }.market-content-card div { min-width: 0; display: grid; gap: 4px; }.market-content-card strong { overflow: hidden; color: #344f42; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }.market-content-card small, .market-content-card p { margin: 0; color: #819087; font-size: 12px; line-height: 1.45; }.market-toolbar { display: grid; grid-template-columns: 130px 130px 130px 140px minmax(170px, 1fr) auto; gap: 9px; align-items: end; margin-top: 10px; }.market-toolbar label { display: grid; gap: 5px; color: #71837a; font-size: 12px; }.market-toolbar input, .market-toolbar select { width: 100%; min-height: 34px; border: 1px solid #d9e4dd; border-radius: 6px; padding: 0 9px; background: #fff; color: #30483d; font: inherit; font-size: 12px; }.market-search > div { display: flex; align-items: center; gap: 6px; min-height: 34px; border: 1px solid #d9e4dd; border-radius: 6px; padding: 0 9px; background: #fff; }.market-search input { min-height: 27px; border: 0; padding: 0; outline: 0; }.market-table-wrap { overflow: auto; margin-top: 8px; }.market-table-wrap table { width: 100%; min-width: 540px; border-collapse: collapse; }.market-table-wrap th, .market-table-wrap td { border-bottom: 1px solid #ebf0ed; padding: 9px 7px; color: #5b6f65; font-size: 12px; text-align: left; white-space: nowrap; }.market-table-wrap th { color: #87968e; font-weight: 500; }.market-table-wrap td strong { color: #365245; }.market-name { max-width: 230px; overflow: hidden; color: #304d40 !important; text-overflow: ellipsis; }.market-up { color: #187b56; }.market-down { color: #ad6654; }.market-tag { border-radius: 999px; padding: 3px 7px; background: #edf1ef; color: #7d8c84; font-size: 12px; }.market-tag.active { background: #e0f3ea; color: #187b56; }.market-empty { padding: 28px 8px !important; color: #8c9b93 !important; text-align: center !important; font-size: 12px; }.market-boundary { display: grid; gap: 3px; margin: 14px 0 20px; border-top: 1px solid #e1e8e3; padding-top: 12px; color: #7b8c83; font-size: 12px; }.market-boundary span { display: inline-flex; align-items: center; gap: 5px; color: #61776b; }.market-boundary p { margin: 0; }
...
.market-hero-actions small { color: #829188; font-size: 12px; }
...
.market-kpi span { color: #718279; font-size: 12px; }
.market-kpi strong { color: #2f4b3e; font-size: 18px; font-weight: 680; }
.market-kpi small { grid-column: 1 / -1; overflow: hidden; color: #94a099; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
.market-meta { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-top: 10px; padding: 10px 14px; }
.market-meta > div { display: flex; align-items: center; flex-wrap: wrap; gap: 7px; color: #718279; font-size: 12px; }
.market-meta svg { color: #348164; }.market-meta strong { color: #395347; }
.market-boundary-pill { border-radius: 999px; padding: 4px 8px; background: #f3f6f4; color: #7e8d85; font-size: 12px; white-space: nowrap; }
...
.decision-title strong { font-size: 12px; }
.decision-title small { margin-left: 0; }
.decision-card p { margin: 4px 0; font-size: 12px; }
.decision-action { display: block; color: #3d745d; font-size: 12px; line-height: 1.45; }
...
.audit-score > span { align-self: center; color: #6f8278; font-size: 12px; }
...
.market-details > summary span { font-size: 12px; font-weight: 650; }
.market-details > summary small { color: #89978f; font-size: 12px; }
...
.market-content-list b { color: #25805e; font-size: 12px; }.market-content-list div { min-width: 0; display: grid; gap: 3px; }
.market-content-list strong { overflow: hidden; color: #365045; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
.market-content-list small { overflow: hidden; color: #84938b; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
...
.market-sample-heading p { color: #87968e; font-size: 12px; }.market-sample-heading h2 { color: #2f4b3e; font-size: 14px; }.market-sample-heading small { color: #93a098; font-size: 12px; }
...
.sample-type { display: inline-flex; min-width: 38px; justify-content: center; border-radius: 999px; padding: 3px 7px; background: #edf3f0; color: #567166; font-size: 12px; }
