...
<style scoped>
.utry-heading { align-items: flex-end; }.utry-heading-actions { display: grid; justify-items: end; gap: 10px; }.utry-date-filter { display: flex; align-items: center; gap: 7px; }.utry-date-filter input, .utry-date-filter button, .utry-table-toolbar input, .utry-table-toolbar select { min-height: 34px; border: 1px solid #dbe4df; border-radius: 6px; background: #fff; color: #385145; font: inherit; }.utry-date-filter input { padding: 0 9px; }.utry-date-filter span { color: #809187; font-size: 12px; }.utry-date-filter button { display: inline-flex; align-items: center; gap: 5px; padding: 0 12px; cursor: pointer; }.utry-data-status { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; }.utry-data-status article { display: flex; align-items: center; justify-content: space-between; gap: 12px; min-height: 66px; padding: 12px 15px; border: 1px solid #dce5e0; border-radius: 8px; background: #fff; }.utry-data-status article > div { display: flex; align-items: center; gap: 9px; }.utry-data-status article span { display: grid; gap: 2px; }.utry-data-status strong { color: #28453a; font-size: 12px; }.utry-data-status small, .utry-data-status em { color: #71847a; font-size: 12px; font-style: normal; }.utry-data-status .is-complete { border-left: 3px solid #38a477; }.utry-data-status .is-partial { border-left: 3px solid #e0a447; }.utry-data-status .is-no-data { border-left: 3px solid #8ba3be; }.utry-data-status .is-missing { border-left: 3px solid #d27768; }.utry-data-status > p { grid-column: 1 / -1; display: flex; align-items: center; gap: 6px; margin: 0; color: #9b6b28; font-size: 12px; }.utry-metrics { grid-template-columns: repeat(4, minmax(0, 1fr)); }.utry-chart-grid { align-items: stretch; }.utry-middle-grid { display: grid; grid-template-columns: minmax(0, 1.55fr) minmax(300px, .75fr); gap: 14px; }.utry-config-list { display: grid; gap: 12px; padding-top: 8px; }.utry-config-list > div { display: grid; grid-template-columns: minmax(0, 1fr) auto auto; align-items: center; gap: 12px; padding: 13px 14px; border: 1px solid #e3eae6; border-radius: 7px; background: #fbfcfb; }.utry-config-list span { display: flex; align-items: center; gap: 8px; color: #587064; font-size: 12px; }.utry-config-list strong { color: #213e32; font-size: 18px; }.utry-config-list em { min-width: 56px; color: #2f7d68; font-size: 12px; font-style: normal; text-align: right; }.utry-table-toolbar { display: flex; justify-content: space-between; gap: 10px; margin-bottom: 12px; }.utry-table-toolbar label { display: flex; align-items: center; gap: 7px; width: min(430px, 100%); min-height: 34px; padding: 0 10px; border: 1px solid #dbe4df; border-radius: 6px; color: #72867b; background: #fff; }.utry-table-toolbar label input { width: 100%; min-height: 30px; padding: 0; border: 0; outline: 0; }.utry-table-toolbar select { padding: 0 10px; }.utry-table-wrap { overflow-x: auto; border: 1px solid #e1e8e4; border-radius: 7px; }.utry-table { min-width: 1060px; }.utry-row { display: grid; grid-template-columns: minmax(300px, 2.15fr) repeat(6, minmax(96px, .72fr)) minmax(120px, .8fr); align-items: center; min-height: 58px; border-bottom: 1px solid #edf1ef; }.utry-row:last-child { border-bottom: 0; }.utry-row > * { padding: 9px 10px; color: #52685d; font-size: 12px; }.utry-head { min-height: 40px; background: #f6f9f7; }.utry-head > span { color: #6a7d73; font-weight: 700; }.utry-product-name { display: grid; gap: 4px; }.utry-product-name strong { color: #29473b; font-size: 12px; line-height: 1.45; }.utry-product-name small { color: #819188; font-size: 12px; }.utry-config-tags { display: flex; gap: 4px; }.utry-config-tags em { padding: 3px 5px; border-radius: 4px; background: #f1f3f2; color: #9aa69f; font-size: 12px; font-style: normal; }.utry-config-tags em.on { background: #e8f5ef; color: #287b60; }.utry-pagination { display: flex; align-items: center; justify-content: space-between; padding-top: 12px; color: #73867b; font-size: 12px; }.utry-pagination div { display: flex; gap: 6px; }.utry-pagination button { display: grid; place-items: center; width: 32px; height: 30px; border: 1px solid #dce4e0; border-radius: 5px; background: #fff; color: #405b4e; cursor: pointer; }.utry-pagination button:disabled { cursor: default; opacity: .4; }.utry-error { display: grid; justify-items: center; gap: 9px; padding: 48px 20px; color: #9c5b4e; }.utry-error span { color: #77877f; font-size: 12px; }.utry-error button { padding: 8px 14px; border: 1px solid #d9e3de; border-radius: 6px; background: #fff; cursor: pointer; }
