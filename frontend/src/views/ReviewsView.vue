...
.review-hero p, .review-panel p { margin: 0 0 5px; color: #21845f; font-size: 12px; font-weight: 700; }
...
.review-collection-feedback { display: flex; align-items: center; gap: 8px; margin-top: 12px; border: 1px solid #cfe8d8; padding: 9px 12px; color: #24754f; background: #f0faf3; font-size: 12px; }
...
.ask-intro strong, .ask-intro span { display: block; }.ask-intro strong { color: #2c617d; font-size: 13px; }.ask-intro span { margin-top: 5px; color: #718996; font-size: 12px; line-height: 1.55; }
...
.review-diagnosis p { margin: 0 0 5px; color: #b07b2f; font-size: 12px; font-weight: 700; }
...
.review-kpis span { color: #7a8b81; font-size: 12px; }.review-kpis strong { color: #30473a; font-size: 17px; }.review-kpis small { grid-column: 2; color: #9aa69f; font-size: 12px; }
...
.review-tag-list { display: flex; flex-wrap: wrap; gap: 8px; padding: 15px; }.review-tag-list button { border: 1px solid #d8e8de; border-radius: 999px; padding: 7px 10px; color: #4c6b5a; background: #f4faf6; font: inherit; font-size: 12px; cursor: pointer; }.review-tag-list button.selected { border-color: #21845f; color: #fff; background: #21845f; }.review-tag-list button strong { margin-left: 4px; }.review-muted { padding: 16px; color: #95a199; font-size: 12px; }
...
.review-risk-list small { margin-top: 4px; color: #96a39b; font-size: 12px; }
.review-risk-list em { color: #7f8e85; font-size: 12px; font-style: normal; text-align: right; }
.review-risk-list b { color: #b06f32; font-size: 12px; text-align: right; }
.review-competitor-list { display: grid; gap: 12px; padding: 16px; }.review-competitor-list > div { display: grid; grid-template-columns: 74px 1fr 34px; align-items: center; gap: 10px; color: #60746a; font-size: 12px; }.review-competitor-list i { height: 6px; overflow: hidden; border-radius: 5px; background: #edf3ef; }.review-competitor-list em { display: block; height: 100%; border-radius: inherit; background: #e0a54b; }.review-competitor-list strong { color: #3e5648; text-align: right; }
...
.competitor-rank { color: #b38a45; font-size: 12px; font-weight: 750; }
.competitor-name { color: #3d5748; font-size: 12px; font-weight: 700; }
.competitor-rank-grid strong { color: #405449; font-size: 12px; }
.competitor-rank-grid small { grid-column: 2 / 4; color: #8a9a91; font-size: 12px; }
...
.ask-category-list { display: grid; gap: 5px; padding: 13px 15px 15px; }.ask-category-list button { display: grid; grid-template-columns: 94px minmax(80px, 1fr) 40px 54px; align-items: center; gap: 9px; border: 0; padding: 7px 0; color: #587064; background: transparent; font: inherit; font-size: 12px; text-align: left; cursor: pointer; }.ask-category-list button.selected { color: #176b4b; font-weight: 700; }.ask-category-list i { height: 6px; overflow: hidden; border-radius: 99px; background: #edf3ef; }.ask-category-list i em { display: block; height: 100%; border-radius: inherit; background: #5c9fbd; }.ask-category-list strong { color: #405449; font-size: 12px; text-align: right; }.ask-category-list small { color: #96a39b; font-size: 12px; text-align: right; }.ask-actions { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 1px; background: #e9efeb; }.ask-actions article { min-height: 90px; padding: 13px 15px; background: #fff; }.ask-actions strong, .ask-actions span { display: block; }.ask-actions strong { color: #405449; font-size: 12px; }.ask-actions span { margin-top: 6px; color: #7f9086; font-size: 12px; line-height: 1.55; }
.review-table-panel { min-height: 200px; }.review-table { padding: 0 15px; }.review-row { display: flex; justify-content: space-between; gap: 18px; border-bottom: 1px solid #edf2ee; padding: 14px 0; }.review-row:last-child { border-bottom: 0; }.review-row-main { min-width: 0; flex: 1; }.review-row-meta { display: flex; align-items: baseline; gap: 10px; }.review-row-meta strong { overflow: hidden; color: #405449; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }.review-row-meta span, .review-row-side span { color: #96a39b; font-size: 12px; }.review-row-main p { margin: 7px 0; overflow: hidden; color: #5c6f63; font-size: 12px; font-weight: 400; line-height: 1.55; text-overflow: ellipsis; white-space: nowrap; }.review-row-tags { display: flex; flex-wrap: wrap; gap: 5px; }.review-row-tags button, .review-row-tags span { border: 0; border-radius: 3px; padding: 3px 6px; color: #557765; background: #f0f7f2; font: inherit; font-size: 12px; cursor: pointer; }.review-row-tags span { color: #9a7a43; background: #fbf6eb; }.review-row-side { display: grid; flex: 0 0 110px; align-content: center; justify-items: end; gap: 4px; }.review-row-side strong { color: #52645a; font-size: 12px; }.review-row-side em { border-radius: 3px; padding: 3px 6px; font-size: 12px; font-style: normal; }.review-row-side em.negative { color: #a44d4d; background: #fff0f0; }.review-row-side em.normal { color: #5f806c; background: #eff8f2; }
...
.review-data-table th { border-bottom: 1px solid #dfeae3; padding: 11px 8px; color: #819087; font-size: 12px; font-weight: 650; text-align: left; white-space: nowrap; }
.review-data-table td { border-bottom: 1px solid #edf2ee; padding: 12px 8px; color: #52675a; font-size: 12px; vertical-align: top; }
...
.review-data-table td small { margin-top: 4px; color: #96a39b; font-size: 12px; }
...
.table-tags button { border: 0; border-radius: 3px; padding: 3px 5px; color: #557765; background: #f0f7f2; font-size: 12px; cursor: pointer; }
.review-data-table td em { border-radius: 3px; padding: 3px 6px; font-size: 12px; font-style: normal; white-space: nowrap; }
...
.review-pagination { display: flex; align-items: center; flex-wrap: wrap; justify-content: flex-end; gap: 9px; padding-top: 14px; color: #87968d; font-size: 12px; }.pagination-total { margin-right: auto; }
.review-pagination label { display: inline-flex; align-items: center; gap: 5px; white-space: nowrap; }.review-pagination select, .review-pagination input { min-height: 28px; border: 1px solid #d8e5dc; border-radius: 4px; padding: 0 6px; color: #557765; background: #fff; font: inherit; font-size: 12px; }.review-pagination input { width: 46px; text-align: center; }.pagination-pages { display: inline-flex; gap: 4px; }.review-pagination button { border: 1px solid #d8e5dc; border-radius: 4px; padding: 6px 9px; color: #557765; background: #fff; font: inherit; cursor: pointer; }.review-pagination button.active { border-color: #21845f; color: #fff; background: #21845f; }
