...
def main() -> int:
    parser = argparse.ArgumentParser(description="Ingest a saved SYCM customer overview response.")
    ...
    result = WarehouseStore(args.database_path).ingest_sycm_customer_overview(
