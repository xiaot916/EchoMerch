...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Ingest a saved CPS daily overview response."
    )
    ...
    result = WarehouseStore(args.database_path).ingest_cps_overview(
...
if __name__ == "__main__":
    try:
        ...
        print(f"CPS ingestion failed: {exc}", file=sys.stderr)
