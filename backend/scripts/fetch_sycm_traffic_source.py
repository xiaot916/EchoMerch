...
def fetch_sycm_traffic_source(
    *,
    ...
    url = f"https://sycm.taobao.com/flow/v5/shop/source/tree/v4.json?{urlencode(params)}"
    request = Request(
        url,
        headers={
            "accept": "*/*",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch SYCM traffic source tree with runtime cookies.")
