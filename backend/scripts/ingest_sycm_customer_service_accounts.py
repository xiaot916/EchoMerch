...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Ingest a saved SYCM customer-service account summary response."
    )
    ...
    result = WarehouseStore(args.database_path).ingest_sycm_customer_service_accounts(
