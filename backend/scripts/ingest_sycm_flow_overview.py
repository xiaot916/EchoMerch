...
def main() -> int:
    parser = argparse.ArgumentParser(description="Ingest a saved SYCM flow overview response.")
    ...
    result = WarehouseStore(args.database_path).ingest_sycm_flow_overview(
