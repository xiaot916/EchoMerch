...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Ingest a saved PZ brand-search daily report response."
    )
    ...
    result = WarehouseStore(args.database_path).ingest_brandsearch_report(
...
if __name__ == "__main__":
    try:
        ...
        print(f"PZ brand-search ingestion failed: {exc}", file=sys.stderr)
