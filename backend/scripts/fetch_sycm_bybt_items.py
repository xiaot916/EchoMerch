...
def main() -> int:
    ...
    result = fetch_sycm_bybt_items(day=args.day, output=args.output, cookie=session.cookie_header, token=args.token, page=args.page, page_size=args.page_size, timeout=args.timeout)
