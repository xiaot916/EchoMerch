...
from app.api.v1.routes.promotion_intel import router as promotion_intel_router
...
api_router.include_router(promotion_intel_router, prefix="/promotion-intel", tags=["promotion-intel"])
