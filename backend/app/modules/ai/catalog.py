...
DATASET_CATALOG: dict[str, DatasetDefinition] = {
    ...
    "new_customer_discount": DatasetDefinition(
        "new_customer_discount", "新客折扣", "store_daily_new_customer_discount_overviews", "新客折扣-日",
        dimensions=_dims(("date", "业务日期", "业务日期")),
        measures=_measures(
            ("shop_visitors", "店铺访客数", "店铺访客数", "person", "sum"),
            ("product_new_visitors", "商品新访客数", "商品新访客数", "person", "sum"),
            ("buyers", "折扣新客支付人数", "新客支付人数", "person", "sum"),
            ("buyer_share", "折扣新客支付人数占比", "新客支付人数占比", "percent", "avg"),
            ("gmv", "折扣新客支付金额", "新客支付金额", "CNY", "sum"),
            ("gmv_share", "折扣新客支付金额占比", "新客支付金额占比", "percent", "avg"),
            ("conversion_rate", "折扣新客支付转化率", "新客支付转化率", "percent", "avg"),
